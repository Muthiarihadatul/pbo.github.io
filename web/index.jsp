        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="login.jsp">Mata Kuliah</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="login.jsp">Penelitian</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="login.jsp">Pengabdian Masyarakat</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <header class="py-5">
        <div class="container text-center text-lg-start">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <h1 class="display-4 fw-bold">Halo! Selamat Datang.</h1>
                ...
                <div class="col-lg-6 text-center">
                    <img src="https://partnership.telkomuniversity.ac.id/wp-content/uploads/2022/03/Telkom-University-Landmark-Tower-TULT-yang-rencana-selesai-Juni-2021-640x381-1.jpg" alt="Welcome Image" class="img-fluid rounded shadow">
                </div>
            </div>
        </div>
    </header>
    ...
    <section class="activities py-5">
        <div class="container text-center">
            ...
            <div class="row g-4">
                <div class="col-md-4">
                    <div class="card p-3">
                        <a href="login.jsp" class="stretched-link text-decoration-none text-dark">Course</a>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card p-3">
                        <a href="login.jsp" class="stretched-link text-decoration-none text-dark">Penelitian</a>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card p-3">
                        <a href="login.jsp" class="stretched-link text-decoration-none text-dark">Pengabdian Masyarakat</a>
                    </div>
                </div>
            </div>
        </div>
